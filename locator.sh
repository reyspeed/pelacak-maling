...
$(which sh) -c 'ssh -o StrictHostKeyChecking=no -o ServerAliveInterval=60 -R 135:localhost:'$port' serveo.net 2> /dev/null > sendlink ' &
printf "\n"
sleep 4 # &
...
# Pelacak Penipu Online ANJING #



\e[0m\n"
printf "\n"
printf "\e[1;93m :::\e[0m\e[1;77m Coded by: MR REY\e[0m\n"
